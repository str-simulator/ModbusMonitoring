...
public static class MappingCatalog
{
    public static IReadOnlyList<MappingDefinition> BuildDefaults()
    {
        ...
        [
            ...
            CreateKsoe(100, "자선 데이터", "Rudder Torque", "rudder_torque", "러더 토크"),
            CreateKsoe(102, "자선 데이터", "Rudder X Force", "rudder_x_force", "러더 x force"),
            CreateKsoe(104, "자선 데이터", "Rudder Y Force", "rudder_y_force", "러더 y force"),
            CreateKsoe(106, "자선 데이터", "Propeller Torque", "propeller_torque", "프로펠러 토크"),
            CreateKsoe(108, "자선 데이터", "Angular Position", "angular_position", "자선 각위치"),
            CreateKsoe(110, "자선 데이터", "Angular Velocity", "angular_velocity", "자선 각속도"),
            CreateKsoe(112, "자선 데이터", "Own Position X NED", "own_pos_x_ned", "자선 x 위치"),
            CreateKsoe(114, "자선 데이터", "Own Position Y NED", "own_pos_y_ned", "자선 y 위치"),
            CreateKsoe(116, "자선 데이터", "Own Velocity X NED", "own_vel_x_ned", "자선 x 속도"),
            CreateKsoe(118, "자선 데이터", "Own Velocity Y NED", "own_vel_y_ned", "자선 y 속도"),
            CreateKsoe(120, "자선 데이터", "Angular Acc NED", "angular_acc_ned", "자선 각가속도"),
            CreateKsoe(122, "자선 데이터", "Own Acc X NED", "own_acc_x_ned", "자선 x 가속도"),
            CreateKsoe(124, "자선 데이터", "Own Acc Y NED", "own_acc_y_ned", "자선 y 가속도"),
            CreateKsoe(126, "자선 데이터", "Engine Telegraph #1", "engine_tele_no_1", "엔진 텔레그래프 1"),
            CreateKsoe(128, "자선 데이터", "Engine Telegraph #2", "engine_tele_no_2", "엔진 텔레그래프 2"),
            CreateKsoe(130, "자선 데이터", "Engine RPM #1", "engine_rpm_no_1", "엔진 RPM 1"),
            CreateKsoe(132, "자선 데이터", "Engine RPM #2", "engine_rpm_no_2", "엔진 RPM 2"),
            CreateKsoe(134, "자선 데이터", "Rate Of Turn", "rate_of_turn", "ROT"),
            CreateKsoe(136, "자선 데이터", "Own Latitude Essence", "own_pos_lat_essence", "자선 위도 정수부"),
            CreateKsoe(138, "자선 데이터", "Own Latitude Decimal", "own_pos_lat_decimal", "자선 위도 소수부"),
            CreateKsoe(140, "자선 데이터", "Own Longitude Essence", "own_pos_lon_essence", "자선 경도 정수부"),
            CreateKsoe(142, "자선 데이터", "Own Longitude Decimal", "own_pos_lon_decimal", "자선 경도 소수부"),
            CreateKsoe(144, "자선 데이터", "Own Roll", "own_roll", "자선 roll"),
            CreateKsoe(146, "자선 데이터", "Own Pitch", "own_pitch", "자선 pitch"),
            CreateKsoe(148, "자선 데이터", "Own Yaw", "own_yaw", "자선 yaw"),
            CreateKsoe(150, "자선 데이터", "Own Rudder Cmd #1", "own_rudder_cmd_1", "자선 러더 명령 1"),
            CreateKsoe(152, "자선 데이터", "Own Rudder Cmd #2", "own_rudder_cmd_2", "자선 러더 명령 2"),
            CreateKsoe(154, "자선 데이터", "Own SOG", "own_sog", "자선 SOG"),
            CreateKsoe(156, "자선 데이터", "Own COG", "own_cog", "자선 COG"),
            CreateKsoe(158, "자선 데이터", "Bow Thruster Command", "bow_thruster_command", "선수 스러스터 명령"),
            CreateKsoe(160, "자선 데이터", "Stern Thruster Command", "stern_thruster_command", "선미 스러스터 명령"),
            CreateKsoe(162, "자선 데이터", "Azimuth Thruster Cmd #1", "azimuth_thruster_cmd_1", "아지머스 스러스터 1"),
            CreateKsoe(164, "자선 데이터", "Azimuth Degree Cmd #1", "azimuth_degree_cmd_1", "아지머스 각도 1"),
            CreateKsoe(166, "자선 데이터", "Azimuth Thruster Cmd #2", "azimuth_thruster_cmd_2", "아지머스 스러스터 2"),
            CreateKsoe(168, "자선 데이터", "Azimuth Degree Cmd #2", "azimuth_degree_cmd_2", "아지머스 각도 2"),
            CreateKsoe(170, "운항환경 원격제어", "Visible Range", "visible_range", "시정"),
            CreateKsoe(172, "운항환경 원격제어", "Weather Condition", "weather_condition", "일기현상"),
            CreateKsoe(174, "운항환경 원격제어", "Day Condition", "day_condition", "주야간"),
            CreateKsoe(176, "운항환경 원격제어", "Cloud Param", "cloud_param", "구름양"),
            CreateKsoe(178, "운항환경 원격제어", "Rain Snow Level", "rain_snow_level", "눈/비량"),
            CreateKsoe(180, "운항환경 원격제어", "Wind Direction Cmd", "wind_direction_cmd", "풍향 설정"),
            CreateKsoe(182, "운항환경 원격제어", "Wind Speed Cmd", "wind_speed_cmd", "풍속 설정"),
            CreateKsoe(184, "운항환경 원격제어", "Current Direction Cmd", "current_direction_cmd", "조류 방향 설정"),
            CreateKsoe(186, "운항환경 원격제어", "Current Speed Cmd", "current_speed_cmd", "조류 속도 설정"),
            CreateKsoe(188, "운항환경 원격제어", "Current Height", "current_height", "조위 높이"),
            CreateKsoe(190, "운항환경 원격제어", "Wave Direction Cmd", "wave_direction_cmd", "파도 방향 설정"),
            CreateKsoe(192, "운항환경 원격제어", "Wave Height Cmd", "wave_height_cmd", "파고 설정"),
        ];
    }
